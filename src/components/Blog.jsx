    ...
    <div className="my-container mt-32">
      ...
      <div className="w-[800px] mx-auto p-8 border rounded-md my-10 hover:border-purple-400">
        ...
        <p className="mt-5">
          ...
          normal react data transfer process you need to transfer data through every component using
          props from upstream to downstream. But, in context API you can pass data from top-most to
          bottom-most component without using any component in-between them.
        </p>
      </div>
      <div className="w-[800px] mx-auto p-8 border rounded-md my-10 hover:border-purple-400">
      ...
      <div className="w-[800px] mx-auto p-8 border rounded-md my-10 hover:border-purple-400">
        ...
        <p className="mt-5">
          useRef helps to persists values of data between renders. It won't re-render like useState
          hook. You can also use it to access a dom element directly.
        </p>
      </div>
      <div className="w-[800px] mx-auto p-8 border rounded-md my-10 hover:border-purple-400">
